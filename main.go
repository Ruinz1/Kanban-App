...
func FlyURL() string {
	// return "https://cavitasanti-final-project-be2981380.fly.dev" // TODO: replace this
	return ""
}

func main() {
	//TODO: hapus jika sudah di deploy di fly.io
	os.Setenv("DATABASE_URL", "postgres://postgres:minimal8karakter@localhost:5432/postgres")
